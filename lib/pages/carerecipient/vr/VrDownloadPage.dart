...
class VrDownloadPageWidget extends StatefulWidget {
  const VrDownloadPageWidget({super.key, required this.isVideo});
  final bool isVideo;

  @override
  _VrDownloadPageWidgetState createState() => _VrDownloadPageWidgetState();
}

class _VrDownloadPageWidgetState extends State<VrDownloadPageWidget>
