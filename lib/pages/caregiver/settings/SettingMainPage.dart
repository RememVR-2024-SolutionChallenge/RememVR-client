                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    SettingNotificationPrefPageWidget()));
                      },
                      child: ContentCard(
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    SettingHelpAndSupportsPageWidget()));
                      },
                      child: ContentCard(
                    ...
                    InkWell(
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      SettingTermOfServicePageWidget()));
                        },
                        child: ContentCard(
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    SettingPrivacyPolicyPageWidget()));
                      },
                      child: ContentCard(
